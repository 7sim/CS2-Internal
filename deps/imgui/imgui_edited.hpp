...
namespace edited
{
    ...
    bool ImageSkinButton(const char* skin_name, ImTextureID texture_id, const ImVec2& size, const ImVec4& bg_col, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
    void            ImageSkin(const char* skin_name, ImTextureID user_texture_id, const ImVec2& size, ImU32 rarity_col, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
    bool ButtonPlus(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, ImTextureID plus_texture, bool selected = false);

    bool           CheckboxWithPopup(bool popup_box, const char* label, const char* hint, bool* v, int* key = 0, int* mode = 0 , bool* value = 0, bool keybind = 0, bool picker = 0, Color_t* color = nullptr, ImGuiColorEditFlags flags = 0);
